    ...
    <div class="row">
        <div class="col-sm-12 col-sm-offset-0">
            <div class="panel panel-default">
                ...
                <form role="form" action="{{ url('/admin/project') }}" method="POST" enctype="multipart/form-data">{{ csrf_field() }}
                    <div class="col-sm-2">
                        <b>Active/Inactive</b>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="date" class="form form-control" name="date" value="">
                        <br>
                        <label class="form text-left">Client</label>
                        <input type="text" class="form form-control" name="client" value="">
                        <br>
                        <label class="form text-left">Role</label>
                        <input type="text" class="form form-control" name="role" value="">
                        <br>
                        ...
                        <input type="text" class="form form-control" name="tags" value="">
                        <br>
                        ...
                        <input type="text" class="form form-control" name="external_url" value="">
                    </div>
                </form>
                </div>
